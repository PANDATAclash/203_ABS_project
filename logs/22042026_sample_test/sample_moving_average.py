...
# =========================
INPUT_FILE = "221422.CSV"      # Change this to another log file when needed
WINDOW_SIZE = 12               # Change this to another sample count when needed
LOW_PASS_ALPHA = 0.17           # Change this alpha when needed
RAW_COLUMN = "lin_ax_raw_mps2"
FILTERED_COLUMN = "lin_ax_filt_mps2"
TIME_COLUMN = "t_s"
